...
namespace JDP
{
    ...
    public class FLVFile : IDisposable
    {
        ...
        private string _inputPath, _outputDirectory, _outputPathBase;
        ...
        private bool _extractAudio, _extractVideo, _extractTimeCodes;
        private bool _extractedAudio, _extractedVideo, _extractedTimeCodes;
